...
-- Encode current line or visual selection with ROT13 + HTML comments
...
-- Decode ROT13 html comment block and remove comment lines
local function rot13_decode_html()
  ...
  if lines[1] == "<!-- ROT ENCODED -->" and lines[3] == "<!-- /ROT -->" then
    ...
    vim.api.nvim_out_write("No ROT HTML comment block found\n")
  end
end

vim.api.nvim_create_user_command("ROT13Encode", function()
  rot13_encode_html()
end, { range = true })

vim.api.nvim_create_user_command("ROT13Decode", function()
  rot13_decode_html()
end, {})
