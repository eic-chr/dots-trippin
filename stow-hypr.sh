...
packages=(waybar Kvantum hypr rofi wlogout swaync wallust ags quickshell swappy btop cava fastfetch qt5ct qt6ct dunst swww hyprlock hypridle hyprpaper nwg-dock-hyprland)
