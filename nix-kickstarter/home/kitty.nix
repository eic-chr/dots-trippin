...
enableZshIntegration = true;
    ...
    keybindings = {
      ...
      "ctrl+alt+f" = "toggle_maximized";  # Fenster "füllt" den verfügbaren Platz
      "ctrl+alt+r" = "reset_window_sizes"; # Zurücksetzen der Fenstergrößen
      
      # Multi-Monitor Support (falls verfügbar)
      "ctrl+shift+1" = "detach_window new-tab";     # Fenster zu neuem Tab
      "ctrl+shift+2" = "detach_window";             # Fenster zu neuem OS-Fenster
  ...
  # Zusätzliche Konfiguration über extraConfig
#   programs.kitty.extraConfig = ''
#     # === KEYBOARD SHORTCUTS (nur getestete Actions) ===
...
#     map cmd+shift+f2 edit_config_file
